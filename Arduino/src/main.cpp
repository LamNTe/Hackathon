...
// Function when recv UART is Coordinates
void playChessCoordinates();
void moveChessCoordinates(int Coordinates_X0, int Coordinates_Y0, int Coordinates_X1, int Coordinates_Y1);
void caculateRotationAngle(int x, int y);

// Function for demo
void playChessDemo();

// Function when recv UART is Angle
void playChessAngle();
void moveChessAngle(int statusReset, double theta1_, double theta2_, double theta3_, double theta4_);

// Function for test Angle
void moveChessTest();
...
void loop() {
  ...
  if (bPlayChess == true)
  {
    ...
    // When data recv from Uart is Coordinates
    // playChessCoordinates();

    // When data recv from Uart is Angle
    playChessAngle();

    bPlayChess = false;
  }

  // When want test take Angle for the Coordinates
  // moveChessTest();
}
...
void playChessCoordinates()
{
  if (dataPlayChess[0] == 2)
  {
    ...
    moveChessCoordinates(dataPlayChess[3], dataPlayChess[4], dataPlayChess[5], dataPlayChess[6]);
    ...
    moveChessCoordinates(dataPlayChess[1], dataPlayChess[2], dataPlayChess[3], dataPlayChess[4]);
  }
...
void playChessDemo()
{
  if (dataPlayChess[0] == 2)
  {
    ...
    moveChessAngle(0,76,-44,25,-43);
    
    delay(200);

    // Serial.println("Step2: Moving the chess from (" + String(dataPlayChess[1]) + "," + String(dataPlayChess[2]) + ") to (" + String(dataPlayChess[3]) + "," + String(dataPlayChess[4]) + ")");
    moveChessAngle(1,54,-29,76,-44);
  }
...
void playChessAngle()
{
  if (dataPlayChess[0] == 2)
  {
    ...
    moveChessAngle(0,dataPlayChess[3],dataPlayChess[4],dataPlayChess[5],dataPlayChess[6]);
    
    delay(200);

    // Serial.println("Step2: Moving the chess from (" + String(dataPlayChess[1]) + "," + String(dataPlayChess[2]) + ") to (" + String(dataPlayChess[3]) + "," + String(dataPlayChess[4]) + ")");
    moveChessAngle(1,dataPlayChess[1],dataPlayChess[2],dataPlayChess[3],dataPlayChess[4]);
  }

  // Move normal or Robot win
  else if (dataPlayChess[0] == 1 || dataPlayChess[0] == 3)
  {
    Serial.println("Moving the chess");
    // Serial.println("Only moving the chess from (" + String(dataPlayChess[1]) + "," + String(dataPlayChess[2]) + ") to (" + String(dataPlayChess[3]) + "," + String(dataPlayChess[4]) + ")");
    // moveChess(dataPlayChess[1], dataPlayChess[2], dataPlayChess[3], dataPlayChess[4]);
